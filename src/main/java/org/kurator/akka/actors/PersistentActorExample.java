...
import org.kurator.akka.actors.DateValidator;
...
public class PersistentActorExample {
    public static void main(String... args) throws Exception {
        ...
        final ActorRef persistentActor = 
            system.actorOf(Props.create(DateValidator.class), "persistentActor-4-java");

        Map<String, String> data = new HashMap<>();
        data.put("eventDate", "2011-04-19");

        persistentActor.tell(data, null);
