...
public class TestScientificNameValidator extends TestCase {
   ...
   public void testScientficNameValidator_EightLineFile() throws Exception {
       ...
       sciNameValidator.parameter("serviceClassQN", "fp.services.COLService");
       sciNameValidator.parameter("insertLSID", true);
